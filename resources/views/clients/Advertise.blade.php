    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-lg-5 col-md-6 mb-4 mb-md-0 order-1 order-md-2">
          <img class="img-fluid w-100" src="/client/images/xvertise.png">
        </div>
      </div>
    </div>
 </section>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-5 col-md-6 mb-4 mb-md-0">
          <img class="img-fluid w-100" src="/client/images/xvertise-02.png">
        </div>
      ...
      <ul class="nav nav-pills nav-pills-icon row text-center" id="myTab" role="tablist">
         <li class="nav-item col-md-3 col-sm-6" role="presentation">
            <a class="nav-link shadow active" id="tab-one" data-toggle="tab" href="#tabOne" role="tab" aria-controls="tabOne" aria-selected="true">
               <img src="/client/images/faq/icon-01.svg" alt="">
         ...
         <li class="nav-item col-md-3 col-sm-6" role="presentation">
            <a class="nav-link shadow" id="tab-two" data-toggle="tab" href="#tabTwo" role="tab" aria-controls="tabTwo" aria-selected="false">
             <img src="/client/images/faq/icon-02.svg" alt="">
         ...
         <li class="nav-item col-md-3 col-sm-6" role="presentation">
            <a class="nav-link shadow" id="tab-three" data-toggle="tab" href="#tabThree" role="tab" aria-controls="tabThree" aria-selected="false">
             <img src="/client/images/faq/icon-03.svg" alt="">
