@extends('clients.parials.master')
@section('content')
    <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 mx-auto">
                        <h1 class="mb-5">Bạn thích đọc gì <br> vào ngày hôm nay?</h1>
                        <ul class="list-inline widget-list-inline">
                            <li class="list-inline-item"><a href="tags.html">Sức khỏe</a></li>
                            <li class="list-inline-item"><a href="tags.html">Chế độ ăn</a></li>
                            <li class="list-inline-item"><a href="tags.html">Mẹo vặt</a></li>
                            <li class="list-inline-item"><a href="tags.html">Sức khỏe</a></li>
                            <li class="list-inline-item"><a href="tags.html">Chế độ ăn</a></li>
                            <li class="list-inline-item"><a href="tags.html">Mẹo vặt</a></li>
                            <li class="list-inline-item"><a href="tags.html">Sức khỏe</a></li>
                ...
                <div class="row">
                    <div class="col-lg-4 mb-5">
                        ...
                        <article class="card">
                            ...
                            <div class="card-body">
                                <h3 class="h4 mb-3"><a class="post-title" href="post-details.html">Sử dụng táo để tạo cho
                                        món nướng của bạn có màu caramel và kết cấu ẩm</a></h3>
                                <ul class="card-meta list-inline">
                                    <li class="list-inline-item">
                                        <a href="author-single.html" class="card-meta-author">
                                            <img src="/client/images/john-doe.jpg">
                                            <span>Hoàng anh hehe</span>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                    ...
                                    <li class="list-inline-item">
                                        <i class="ti-calendar"></i>14 tháng 1, 2024
                                    </li>
                                    <li class="list-inline-item">
                                ...
                                <p>Không có gì bí mật khi ngành công nghiệp kỹ thuật số đang bùng nổ. Từ các công ty khởi nghiệp thú vị đến …</p>
        ...
        <section class="section-sm">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    @include('clients.parials.sidebar')
                </div>
            </div>
        </section>
    </div>
