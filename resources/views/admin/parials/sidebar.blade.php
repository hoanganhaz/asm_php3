<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/adminn">
        ...
        <div class="sidebar-brand-text mx-3">Hoanganh Admin</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('admin.Category.index')}}">Hiện thị</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('admin.Post.index')}}">Hiện thị</a>
                <a class="collapse-item" href="/create_post">Thêm</a>
                <a class="collapse-item" href="/edit_post">Sửa</a>
            </div>
        </div>
    </li>
